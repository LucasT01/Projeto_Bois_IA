...
export const SAMPLE_CATTLE: CattleRecord[] = [
  ...
  },
  {
    ...
    verdict: 'NÃO APTO',
    aiConfidence: 89.1,
    notes: 'Peso estimado abaixo da faixa esperada para o lote. Recomenda-se acompanhar a evolução do animal.',
    landmarkPoints: [
  ...
  },
  {
    ...
    verdict: 'NÃO APTO',
    aiConfidence: 94.7,
    notes: 'Registro com peso estimado bem abaixo do esperado. Recomenda-se acompanhamento nutricional e revisão do histórico.',
    landmarkPoints: [
